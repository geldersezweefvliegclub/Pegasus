...
export interface components {
  schemas: {
    ref_vliegtuigen_in: {
      ...
      ZITPLAATSEN?: number;
      /** Kan het vliegtuig op eigen kracht starten. Waarde 0..1 */
      ZELFSTART?: boolean;
      /** Is het een club vliegtuig? Waarde 0..1 */
      CLUBKIST?: boolean;
      /** Is het een TMG? Waarde 0..1 */
      TMG?: boolean;
      /** Is het een sleepvliegtuig? Waarde 0..1 */
      SLEEPKIST?: boolean;
    ...
    view_vliegtuigen: {
      ...
      dataset?: (components["schemas"]["ref_vliegtuigen"] &
        ({
