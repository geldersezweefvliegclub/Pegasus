...
@Component({
    ...
    imports: [ErrorComponent, SuccessComponent, FaIconComponent, NgbPopover, LoaderComponent, RecencyGrafiekComponent, InstructieGrafiekComponent, StartGrafiekComponent]
})
